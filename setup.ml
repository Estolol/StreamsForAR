...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3b889a7b55142fc7293f47e25a5e7e27) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Edouard Dufour Sans"];
          homepage = None;
          synopsis =
            "Using instance streams for a fair exploration of search spaces.";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\129<<\234\166\022:\250\156^B\164\002\161\137.";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
